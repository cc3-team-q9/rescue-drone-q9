        ...
        <div className='create-flight-plan-area' style={{display: 'flex', backgroundColor: 'rgb(59, 66, 68)', color: 'white'}}>
          <div className='create-flight-plan-requirement' style={{fontFamily: 'sans-serif', fontSize: '18px', fontWeight: 'bold'}}>
            ...
            <div style={{ marginLeft: 20, marginBottom: 20}}>
              ...
              <div style={{textAlign: 'left', fontSize: '16px', fontWeight: 'initial', marginTop: 10}}>Select hour, minute and second</div>
              <div style={{display: 'flex'}}>
                <SelectBox
                  items={hour}
                  label={'Select hour'}
          ...
          <div className='create-flight-plan-polygon' style={{ textAlign: 'left', marginTop: 20, marginLeft: 20, width: "100%", fontFamily: 'sans-serif', fontSize: '18px', fontWeight: 'bold'}}>
            <CreatePolygon 
              label={'Flight Area'}
